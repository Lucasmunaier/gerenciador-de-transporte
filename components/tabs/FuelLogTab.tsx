...
const FuelLogTab: React.FC = () => {
  ...
  // A sua lógica original de ordenação, que está ótima.
  ...
  return (
    <div className="space-y-6">
      {/* --- ESTRUTURA DE LAYOUT CORRIGIDA AQUI --- */}
      <div>
        <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 mb-4">Controle de Abastecimentos</h2>
        <div className="flex justify-start">
          <button
            onClick={handleAddNew}
            className="flex items-center justify-center bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition duration-150 ease-in-out"
          >
      ...
      <div className="bg-white shadow-xl rounded-lg overflow-hidden">
        {fuelLogs.length === 0 ? (
          <p className="p-8 text-center text-gray-500 text-lg">Nenhum abastecimento registrado ainda.</p>
        ) : (
